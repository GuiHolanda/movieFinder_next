...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-l mt-auto from-gray-800 to-black px-2 sm:px-4 py-2.5 ">
      <div className="flex justify-between">
        <a href="/" className="flex items-center">
          <img
            ...
            alt="Flowbite Logo"
          />
          <span className="self-center text-base text-white font-semibold whitespace-nowrap">
            Movie Finder
          </span>
        </a>
        <ul className="flex space-x-5 ">
          ...
          <li>
            <a href="https://github.com/GuiHolanda" target={'_blank'}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
